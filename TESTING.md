...
```
              ...
              +-----------------------------------+
            +---------------------------------------+
            |          Unit Tests (1449)             |   <- every PR and push
...
```bash
python3 -m pytest tests/ -v                          # all 1449 tests
...
1449 pytest tests across 40+ test files in `tests/`. Major coverage areas:
...
**Total: 93 prompts** (70 fixture-based + 23 skill-bundled)
